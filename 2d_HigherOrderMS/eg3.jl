...
patch_local_node_ids = get_fine_data(ms_space)[3];
...
patch_lmat = lazy_map(assemble_rect_matrix, patch_coarse_trian, patch_fine_spaces, Gridap.Arrays.Fill(p, num_coarse_cells), elem_local_node_ids);
