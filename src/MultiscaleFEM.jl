...
using MultiscaleFEM.MultiscaleBases: CoarseTriangulation, FineTriangulation, MultiScaleTriangulation, MultiScaleFESpace, solve_schur_complement, lazy_fill #, legendre_basis_on_fine_scale
...
export CoarseTriangulation, FineTriangulation, MultiScaleTriangulation, MultiScaleFESpace, solve_schur_complement, lazy_fill #, legendre_basis_on_fine_scale
