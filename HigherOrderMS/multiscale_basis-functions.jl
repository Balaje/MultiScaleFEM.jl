...
function compute_ms_basis_boundary_correction(fspace::FineScaleSpace, D::Function, p::Int64, nc::Int64, l::Int64,
  patch_indices_to_global_indices::Vector{AbstractVector{Float64}}, bnodes::Vector{Int64})
  nf = fspace.nf
  q = fspace.q
  basis_vec_corr = spzeros(Float64, q*nf+1, (p+1)*nc)
  K, L, Λ = get_saddle_point_problem(fspace, D, p, nc)
  f1 = zeros(Float64, size(K,1))
  index = 1
  for t=1:nc
